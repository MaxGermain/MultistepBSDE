...
# create the model
model = mod.Bounded(sigMin, T, xInit, muScal, alpha)
...
print("PDE bounded Splitting  Dim ", d, " layerSize " , layerSize,   "T ", T ,  "batchsize ",batchSize, " batchSizeVal ", batchSizeVal,   "nbOuterLearning" , nbOuterLearning , "num_epochExt ", num_epochExt , " num_epochExt0 " ,  num_epochExt0 ,   "initialLearningRateStep" ,initialLearningRateStep  )
...
for indt  in ndt:
    ...
    Y0List = []
    i=0
    baseFile = "BoundedSPlittingDim"+str(d)+"Step"+str(indt)+"Neur"+str(nbNeuron)+"NbLay"+str(nbLayer)
    while (i < nTest):
        if (i==0):
...
sol = model.SolPoint(0., xInit)
print("Solution", sol)
print("PDE bounded SigMin", sigMin,  "  Dim ", d, " layerSize " , layerSize,   "T ", T ,  "batchsize ",batchSize, " batchSizeVal ", batchSizeVal,   "nbOuterLearning" , nbOuterLearning , "num_epochExt ", num_epochExt , " num_epochExt0 " ,  num_epochExt0 ,   "initialLearningRateStep" ,initialLearningRateStep  )
